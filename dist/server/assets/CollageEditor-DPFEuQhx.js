...
import { DefaultEventPriority, DiscreteEventPriority, ConcurrentRoot } from "react-reconciler/constants.js";
import { unstable_IdlePriority, unstable_now, unstable_runWithPriority } from "scheduler";
...
const scheduleMicrotask = typeof queueMicrotask === "function" ? queueMicrotask : (fn) => Promise.resolve(null).then(fn);
const noTimeout = -1;
...
var useImage$1;
var hasRequiredUseImage;
function requireUseImage() {
  if (hasRequiredUseImage) return useImage$1;
  hasRequiredUseImage = 1;
  var React$1 = React;
  useImage$1 = function useImage2(url, crossOrigin, referrerpolicy) {
    const statusRef = React$1.useRef("loading");
    const imageRef = React$1.useRef();
    const [_, setStateToken] = React$1.useState(0);
    const oldUrl = React$1.useRef();
    const oldCrossOrigin = React$1.useRef();
    const oldReferrerPolicy = React$1.useRef();
...
var useImageExports = requireUseImage();
const useImage = /* @__PURE__ */ getDefaultExportFromCjs(useImageExports);
      ...
      /* @__PURE__ */ jsxs("div", { ref: containerRef, className: "flex-1 bg-slate-900 flex items-center justify-center overflow-hidden p-4 relative", children: [
        ...
        /* @__PURE__ */ jsx("div", { style: { transform: `scale(${stageScale})`, transformOrigin: "center center" }, className: "shadow-2xl", children: /* @__PURE__ */ jsx(
          Stage2,
          {
            ...
            ref: stageRef,
            children: /* @__PURE__ */ jsxs(Layer2, { children: [
              /* @__PURE__ */ jsx(
                Rect2,
                {
                  x: 0,
